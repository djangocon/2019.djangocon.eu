...
SECRET_KEY = env("DJANGO_SECRET_KEY", default="7rbb8w4t_!$f2@_m9-l$7(g*x*x9r(w&bxt9b2b_#6-qohufh%")
...
ROOT_URLCONF = "dceu2019.conf.urls"
...
WSGI_APPLICATION = "dceu2019.conf.wsgi.application"
...
STATIC_ROOT = env("DJANGO_STATIC_ROOT", default=str(BASE_DIR.parent.parent / "staticfiles"))
...
MEDIA_ROOT = env("DJANGO_MEDIA_ROOT", default=str(BASE_DIR.parent.parent / "media"))
